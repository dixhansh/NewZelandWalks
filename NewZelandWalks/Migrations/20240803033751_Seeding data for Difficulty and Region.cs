    ...
    public partial class SeedingdataforDifficultyandRegion : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("26cbb49b-ec90-4c2b-8bf6-e1dafa05120d"), "Easy" },
                    { new Guid("27468d81-cca2-4b61-9a1c-d9a56f118b86"), "Medium" },
                    { new Guid("cecc00d7-0961-47f3-9b46-0623dffc2e7c"), "Hard" }
                });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("26cbb49b-ec90-4c2b-8bf6-e1dafa05120d"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("27468d81-cca2-4b61-9a1c-d9a56f118b86"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("cecc00d7-0961-47f3-9b46-0623dffc2e7c"));
